    ...
    <div class="ButtonContainer">
        <ul id="btn">
            <li class="Button ButtonIcon NormalState" id="SaveButton" tabindex="0">
                ...
                <span class="Text"><asp:Button ID="save" runat="server" Text="保存" BorderStyle="None" OnClick="save_Click" /></span>
            </li>
            <li class="Button ButtonIcon NormalState" id="SaveAndCloneButton" tabindex="0">
                <span class="Icon SaveAndClone"></span>
                <span class="Text"><asp:Button ID="save_close" runat="server" Text="保存&关闭" BorderStyle="None" OnClick="save_close_Click" /></span>
            </li>
            <li class="Button ButtonIcon NormalState" id="SaveAndNewButton" tabindex="0">
                <span class="Icon SaveAndNew"></span>
                <span class="Text"><asp:Button ID="save_add" runat="server" Text="保存&新建" BorderStyle="None" OnClick="save_add_Click" /></span>
            </li>
                            ...
                            <tr>
                                <td>
                                            ...
                                            <tr>
                                                <td class="FieldLabel">
                                                    ...
                                                    <%
                                                        if (!isAdd)
                                                        {
                                                            product = new EMT.DoneNOW.BLL.IVT.ProductBLL().GetProduct(iProduct.product_id);
                                                        }
                                                        %>
                                                    产品 <span style="color: Red;">*</span>
                                                    <div>
                                                        <span style="display: inline-block;"><input type="text" name="productName" id="product_id" value="<%=product==null?"":product.product_name %>" /></span>
                                                         <a onclick="chooseProduct()" class="DataSelectorLinkIcon"><img src="../Images/data-selector.png" alt=""></a>
                                                         <a id="EditProduct" onclick="EditProduct()" style="display:none;" class="DataSelectorLinkIcon"><img src="../Images/data-selector.png" alt=""></a>
                                    ...
                                    <input type="hidden" name="product_id" id="product_idHidden" value="<%=product==null?"":product.id.ToString() %>" />
                                                ...
                                                <td class="FieldLabel">
                                                    激活&nbsp;&nbsp;&nbsp;<span style="display: inline-block;">
                                    ...
                                    %>
                                                ...
                                                <td class="FieldLabel" style="cursor:pointer;margin-left:2px;margin-bottom:-3px;">
                                                    ...
                                                    <div>
                                                        <span style="display: inline-block;">
                                                           ...
                                                           <a id="EditContact" onclick="EditContact()" style="display:none;" class="DataSelectorLinkIcon"><img src="../Images/data-selector.png" alt=""></a>
                                                        </span>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="FieldLabel" style="cursor:pointer;margin-left:2px;margin-bottom:-3px;">
                                                     位置 <span style="color: Red;">*</span>
                                                    <div>
                                                        <span style="display: inline-block;"><input type="text" style="width:250px;"  name="location" id="location" value="<%=(!isAdd)&&iProduct.location!=null?iProduct.location:"" %>" /></span>
                                    ...
                                    <input type="hidden" name="contract_id" id="contract_idHidden" value="<%=(!isAdd)&&iProduct.contract_id!=null?iProduct.contract_id.ToString():"" %>" />
                                                         <a href="#" class="DataSelectorLinkIcon"><img src="../Images/data-selector.png" alt="" /></a>
                                                ...
                                                <tr>
                                                    ...
                                                    序列号 
                                                    <div>
                                                        <span style="display: inline-block;"><input type="text" style="width:250px;" name="serial_number" id="serial_number" value="<%=(!isAdd)&&iProduct.serial_number!=null?iProduct.serial_number:"" %>" /></span>
                                                    </div>
                                                    </td>
                                                  <td class="FieldLabel">
                                                    服务/服务集
                                                 ...
                                                 <tr>
                                                    ...
                                                    参考号 
                                                    <div>
                                                        <span style="display: inline-block;"><input type="text" style="width:250px;" name="reference_number" id="reference_number" value="<%=(!isAdd)&&iProduct.reference_number!=null?iProduct.reference_number:"" %>" /></span>
                                                    </div>
                                                    </td>
                                                      <td class="FieldLabel" style="cursor:pointer;margin-left:2px;margin-bottom:-3px;">
                                                ...
                                                <%--               <label>是否经过合同审核</label>
                                                   ...
                                                   <tr>
                                                    ...
                                                    参考名称 
                                                    <div>
                                                        <span style="display: inline-block;"><input type="text" style="width:250px;" name="reference_name" id="reference_name" value="<%=(!isAdd)&&iProduct.reference_name!=null?iProduct.reference_name:"" %>" /></span>
                                                    </div>
                                                    </td>
                                                      <td>
                                                          物料成本
                                                 ...
                                                 <tr>
                                                    ...
                                                    用户数 
                                                    <div>
                                                        <span style="display: inline-block;"><input type="text" style="width:250px;" name="number_of_users" id="number_of_users" value="<%=(!isAdd)&&iProduct.number_of_users!=null?((decimal)iProduct.number_of_users).ToString("0"):"" %>"  maxlength="11" onkeyup="if(isNaN(value))execCommand('undo')" onafterpaste="if(isNaN(value))execCommand('undo')"  class="Number"  /></span>
                                                    </div>
                                                    </td>
                                                      <td class="FieldLabel">
                                                    供应商
