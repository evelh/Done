                  ...
                  <table cellpadding="0" cellspacing="0" style="width: 100%;">
                    ...
                    <tr>
                      <td class="FieldLabels">
                        <label><%=udf.name %></label>
                        <div>
                           <input onclick="WdatePicker()" type="text" value="<%=udfValue==null?"":(string.IsNullOrEmpty(udfValue.ToString())?"":((DateTime)udfValue).ToString("yyyy-MM-dd")) %>" name="<%=udf.id %>" class="Wdate" />
                        </div>
                      </td>
                    </tr>
                    <%}
