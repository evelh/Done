<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContractCopy.aspx.cs" Inherits="EMT.DoneNOW.Web.Contract.ContractCopy" %>
                                                ...
                                                <div>
                                                    <select name="period_type" class="step2LeftSelectWidth" style="width:134px;">
                                                        <%foreach (var period in periodType) {
                                                                %>
                                                        <option value="<%=period.val %>" <%if (period.val.Equals(contractCopy.period_type)){%> selected="selected"<% } %>><%=period.show %></option>
                                                        <%
                                                            } %>
                                                    </select>
                                                </div>
                                        ...
                                        <%if (contractType == (int)EMT.DoneNOW.DTO.DicEnum.CONTRACT_TYPE.FIXED_PRICE) { %>
                                          <td class="FieldLabels">
                                              ...
                                              <div style="padding:0;">
                                                  ...
                                                  <img src="../Images/data-selector.png" onclick="window.open('../Common/SelectCallBack.aspx?cat=<%=(int)EMT.DoneNOW.DTO.DicEnum.QUERY_CATE.MATERIALCODE_CALLBACK %>&field=defaultCostCode&con439=<%=(int)EMT.DoneNOW.DTO.DicEnum.COST_CODE_CATE.MILESTONE_CODE %>', '<%=(int)EMT.DoneNOW.DTO.OpenWindow.BillCodeCallback %>', 'left=200,top=200,width=600,height=800', false)" style="vertical-align: middle;cursor: pointer;" />
                                              </div>
                                          </td>
                                        <%} %>
                                      </tr>
                                ...
                                <table cellspacing="1" cellpadding="0" width="100%">
                                  <%if (contractType != (int)EMT.DoneNOW.DTO.DicEnum.CONTRACT_TYPE.SERVICE) { %>
                                    <tr>
                                        <td class="FieldLabels">
                                            预估收入
                                            <div>
                                              <input type="text" id="revenue" name="dollars" value="<%=contractCopy.dollars %>" style="text-align: right;width: 176px;" />
                                            </div>
                                        </td>
                                    </tr>
                                  <%}%>
                                  ...
                                  <%if (contractType == (int)EMT.DoneNOW.DTO.DicEnum.CONTRACT_TYPE.PER_TICKET) { %>
                                    <tr>
                                        <td class="FieldLabels">
                                            ...
                                            <div>
                                              <input type="text" value="<%=contractCopy.overage_billing_rate %>" name="overage_billing_rate" style="text-align: right;width: 176px;" />
                                            </div>
                                        </td>
                                    </tr>
                                  <%} else { %>
                                  ...
                                  <%if (contractType == (int)EMT.DoneNOW.DTO.DicEnum.CONTRACT_TYPE.BLOCK_HOURS) { %>
                                    <tr>
                                        <td>
                                            <div>
                                                <input type="checkbox" id="enableOverage" name="enableOverage" <%if (contractCopy.enable_overage_billing_rate == 1) { %> checked="checked" <%} %> style="vertical-align: middle;"/>
                                    ...
                                    <tr>
                                        <td class="FieldLabels">
                                            超额计费费率
                                            <div>
                                              <input type="text" id="overagRate" name="overage_billing_rate" value="<%=contractCopy.overage_billing_rate %>" disabled="disabled" style="text-align: right;width: 176px;" />
                                            </div>
                                        </td>
                                    </tr>
                                  <%}%>
