      ...
      <div class="ButtonContainer">
        <ul id="btn">
          <li class="Button ButtonIcon NormalState" tabindex="0"><i style="background: url(../Images/ButtonBarIcons.png) no-repeat -32px 0;" class="icon-1"></i>
            <input type="button" value="保存并关闭" id="SaveClose" style="outline:none;background:transparent;cursor:pointer;border:none;"/>
          </li>
          <li class="Button ButtonIcon NormalState" tabindex="0"><i style="background: url(../Images/ButtonBarIcons.png) no-repeat -96px 0;" class="icon-1"></i>
            <asp:Button ID="Cancel" runat="server" Text="取消" BorderStyle="None" OnClientClick="javascript:window.close();" style="outline:none;background:transparent;cursor:pointer;"/>
          </li>
        </ul>
      </div>
          ...
          <tbody>
            ...
            <tr>
              <td width="30%" class="FieldLabels">总额<span class="errorSmall">*</span>
                <div>
                  <asp:TextBox ID="dollars" runat="server" style="width:200px;"></asp:TextBox>
                </div>
              </td>
            </tr>
            <tr>
              <td width="30%" class="FieldLabels">截止日期<span class="errorSmall">*</span>
                <div>
                  <input type="text" name="due_date" value="<%=duDate %>" onclick="WdatePicker()" style="width:200px;" class="Wdate"/>
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td width="30%" class="FieldLabels">描述
                <div>
                    <asp:TextBox ID="description" runat="server" TextMode="MultiLine" style="width:200px;height:100px;"></asp:TextBox>
                </div>
              </td>
            </tr>
          </tbody>
