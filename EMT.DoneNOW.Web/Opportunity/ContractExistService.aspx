            ...
            <tbody>
                ...
                <tr>
                    <td width="30%" class="FieldLabels">
                        ...
                        <div style="padding-bottom: 10px;">
                            <input type="checkbox" checked  id="updatePrice" style="vertical-align: middle;margin-left: 40px;">
                            <span class="txtBlack8Class">同时更新单价</span>
                        </div>
                        <div>
                            <input type="checkbox" checked id="updateCost" style="vertical-align: middle;margin-left: 40px;">
