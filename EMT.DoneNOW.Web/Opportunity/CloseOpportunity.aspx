    ...
    <form id="form1" runat="server">
                                ...
                                <table cellspacing="0" cellpadding="0" width="100%">
                                    <tbody>
                                        <tr>
                                            ...
                                            <div>
                                                <input type="text" style="width: 278px;" value="<%=new EMT.DoneNOW.BLL.CRM.OpportunityBLL().ReturnOppoRevenue(opportunity).ToString("0.00") %>">
                                            </div>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td rowspan="3" class="FieldLabels" style="vertical-align: top;">原因描述  <span class="errorSmall">*</span>
                                                <div>
                                                    <textarea style="width: 278px; height: 160px;" name="win_reason" id="win_reason"></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                                ...
                                                <tr>
                                                    <td style="padding-bottom: 8px;">
                                                        <span class="CheckboxLabels">
                                                            ...
                                                            <label id="activeprojectText">从报价项激活项目提案</label>
                                                        </span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="2" align="left" style="color: #333333; padding-right: 0px; margin-right: 0px; width: 75px;">
                                                                            <div>
                                                                                <input type="radio" name="RadioEndDate" checked id="RadioBtnEndDate">
                                                                                <label>结束日期</label>
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="2" align="left" style="color: #333333; padding-right: 0px; margin-right: 0px; width: 75px;">
                                                                            <div style="margin: 0; padding: 0;">
                                                                                <input type="radio" name="RadioEndDate" id="RadioBtnEndAfter">
                                                                                <label>结束于</label>
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td class="FieldLabels">生效日期<span class="errorSmall">*</span>
                                                                            <div style="margin: 0; padding: 0;">
                                                                                <input type="text" style="width: 95px;" name="effective_date " id="effective_date" onclick="WdatePicker()" class="Wdate">
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                    ...
                                    <td>
                                        ...
                                        <div class="CheckboxLabels">
                                            <div class="Checkbox" style="padding-bottom: 8px;">
                                                <span>
                                                    <asp:CheckBox ID="isIncludePO" runat="server" />
                                            ...
                                            <div class="Checkbox" style="padding-bottom: 8px;">
                                                <span>
                                                    <asp:CheckBox ID="isIncludeShip" runat="server" />
                                            ...
                                            <div class="Checkbox" style="padding-bottom: 8px;">
                                                <span>
                                                    <asp:CheckBox ID="isIncludeCharges" runat="server" />
                                        ...
                                        <div class="RadioList">
                                            <div style="padding-bottom: 10px;">
                                                <span>
                                                    ...
                                                    <label style="color: rgb(176, 176, 176);">服务台工单成本</label>
                                                </span>
                                            </div>
                                            <div style="padding-bottom: 10px;">
                                                <span>
                                            ...
                                            <div style="padding-bottom: 10px;">
                                                <span>
                                                    <input type="radio" disabled name="optProject">
                                                    <label style="color: rgb(176, 176, 176);">合同成本（新合同）</label>
                                                </span>
                                            </div>
                                            <div style="padding-bottom: 10px;">
                                                <span>
                                                    <input type="radio" name="optProject" id="RadioCCEx">
                                                    <label>合同成本（已存在合同）</label>
                                                </span>
                                                            ...
                                                            <tr>
                                                                <td class="FieldLabels" valign="middle">
                                                                    <div>
                                                                        ...
                                                                        <img src="../Images/data-selector.png" alt="">
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                            ...
                                            <div style="padding-bottom: 10px;">
                                                <span>
                                                    ...
                                                    <label>工单成本（创建一个状态为已完成的工单）</label>
                                                </span>
                                            </div>
                                        </div>
                                    </td>
            ...
            <div class="ButtonBar WizardButtonBar" style="width: 97%;">
                <ul>
                    ...
                    <li class="right" id="b2">
                        <a class="ImgLink">
                            <span class="Text"><asp:Button ID="ShowNext" runat="server" Text="下一页" OnClick="ShowNext_Click"  /></span>
                            <img class="ButtonRightImg" src="../Images/move-right.png">
                        </a>
                    </li>
                    <!--完成-->
      ...
      <%--      <div class="PageInstructions">You are about to close an opportunity for a(n) company that may have incomplete address information. If necessary, please update this company's address below.</div>
                            ...
                            <td>
                                <div class="grid">
                                    <table width="100%" cellspacing="0" cellpadding="0">
                                        ...
                                        <tbody id="thisBody">
                                            <tr>
                                                <td id="txtBlack8" style="vertical-align: middle;" nowrap>Hub</td>
                                                <td id="txtBlack8" style="vertical-align: middle;" nowrap align="right">1</td>
                                                <td nowrap align="left">
                                                    <span class="errorSmall">*</span>
                                                    <select style="width: 90%;">
                                                        <option value="">(select)</option>
                                                        <option value="">Change Orders</option>
        ...
        <div class="Workspace Workspace7" style="display: none;">
            <div class="PageInstructions">Please review the selections you have made in the window below. Press the Finish button if everything is correct or use the Back button to make changes.</div>
            <div class="WizardSection">
                <table cellspacing="0" cellpadding="0" width="100%">
                    <tbody>
                        <tr height="85%">
                            <td width="90%">
                                <table cellspacing="1" cellpadding="0" width="100%">
                                    <tr>
                                        <td class="FieldLabels">Summary of actions to perform
                                        <div>
                                            <textarea rows="20" style="overflow-x: hidden; overflow-y: auto; width: 98%; height: 480px; resize: none"></textarea>
                                        </div>
                                        </td>
                                    </tr>
                                </table>
    ...
    $("#b2").on("click", function () {
        ...
        if ((!isIncludePO) && (!isIncludeShip) && (!isIncludeCharges))
        {
            ...
            if (isIncludePO) {
              ...
              <%--  thisHtml += " <tr><td id=\"txtBlack8\" style=\"vertical-align: middle;\" nowrap><%=item.name %></td><td id=\"txtBlack8\" style=\"vertical-align: middle;\" nowrap align=\"right\"><%=item.quantity %></td><td nowrap align=\"left\"><span class=\"errorSmall\">*</span><select name='<%=item.id %>_select' id='<%=item.id %>_select' style=\"width: 90%;\">" + $("#codeSelect").val() + "</select></td></tr>;";
               --%>
            }
            // 配送
            if (isIncludeShip) {
