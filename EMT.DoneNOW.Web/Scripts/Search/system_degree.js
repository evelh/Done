...
function Add() {
    window.open("../SysSetting/ResourceDicForm.aspx?type=Degree", windowObj.general + windowType.add, 'left=0,top=0,location=no,status=no,width=400,height=350', false);
}
