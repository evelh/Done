...
function Add() {
    window.open('../General/GeneralManage?tableId=134', windowObj.general + windowType.add, 'left=0,top=0,location=no,status=no,width=700,height=500', false);
}
...
function Delete() {
    $.ajax({
        type: "GET",
        url: "../Tools/GeneralViewAjax.ashx?act=delete_validate&GT_id=134&id=" + entityid,
        async: false,
        //dataType: "json",
