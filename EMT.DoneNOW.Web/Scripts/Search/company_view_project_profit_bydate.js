$(function () {
    ...
    if ($("input[name = 'con3590']").val() != undefined) {
        $("#ProjectStatus").val($("input[name = 'con3590']").eq(0).val());
    }
    $("#BillSelectSpan").hide();
    $("#BillSpanName").hide();
})
...
$("#Apply").click(function () {
    ...
    var accountId = "";
    if ($("input[name = 'con3591']").val() != undefined) {
        accountId = $("input[name = 'con3591']").eq(0).val();
    }
