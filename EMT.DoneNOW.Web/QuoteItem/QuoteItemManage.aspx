            ...
            <table>
                ...
                <tbody>
                    <%if (groupList != null && groupList.Count > 0)
                        {
                            ...
                            {%>
                    <tr><td><%=item.Key.ToString()==""?"其他":item.Key %></td></tr>
                    <% foreach (var quoteItem in item.Value as List<EMT.DoneNOW.Core.crm_quote_item>)
                        ...
                        <td><%=quoteItem.unit_price %></td>  <%--decimal.Round(decimal.Parse("0.3333333"),2)   Math.Round(Convert.ToDouble((quoteItem.unit_discount/quoteItem.unit_price,2,MidpointRounding.AwayFromZero)))  --%>
                    ...
                    <% }%>
                     <tr>
                        ...
                        else
                        {
                            ...
                            {
                                foreach (var quoteItem in quoteItemList)
                                {%>
                    <tr>
                        <td><%=quoteItem.oid %></td>
                        <td><%=quoteItem.name %></td>
