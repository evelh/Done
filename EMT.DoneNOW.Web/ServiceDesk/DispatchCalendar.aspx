...
<head runat="server">
    ...
    <frame name="BOTTOM" id="BOTTOM" src="../Common/SearchBodyFrame.aspx?cat=<%=(int)EMT.DoneNOW.DTO.DicEnum.QUERY_CATE.DISPATCH_TICKET_SEARCH %>&type=<%=(int)EMT.DoneNOW.DTO.QueryType.DISPATCH_TICKET_SEARCH %>" scrolling="AUTO" DragDropToWindow_Window="TOP;" DragDropToWindow_DragPage="TOP.oDragPage;"></FRAME>
            // 
             <%--src="DispatcherWorkshopTicketView.aspx"--%>
</frameset>
