                        ...
                        <div class="Large Column">
                            <div class="CustomLayoutContainer">
                                <div class="Edit_LayoutBlock">
                                    ...
                                    <div class="Edit_TableBottomDescription">
                                        我的：客户经理、客户团队成员可以查看相关客户信息
我的地域：包含我的
                                    </div>
                                </div>
                                <div class="Edit_LayoutBlock">
                        ...
                        <div class="Large Column">
                            <div class="CustomLayoutContainer">
                                <div class="Edit_LayoutBlock">
                                    ...
                                    <div class="Edit_LayoutTable">
                                        ...
                                        <div class="Edit_Tablebody">
                                            <div class="Edit_TableBodyRow">
                                                ...
                                                <div class="Edit_OneCells Edit_RightBorder Edit_ReadonlyPermission">
                                                    <asp:DropDownList ID="id201" runat="server"></asp:DropDownList></div>
                                                <div class="Edit_OneCells Edit_RightBorder Edit_Narrow">
                                            ...
                                            <div class="Edit_TableBodyRow">
                                                ...
                                                <div class="Edit_OneCells Edit_RightBorder Edit_ReadonlyPermission">
                                                    <asp:DropDownList ID="id210" runat="server"></asp:DropDownList></div>
                                                <div class="Edit_OneCells Edit_RightBorder Edit_Narrow">
                                    ...
                                    <div class="Edit_TableBottomDescription">
                                        1)工单编辑权限设置为“无”，仍然可以在“转发和修改”模块修改工单的标题、内容、队列、主负责人、其他负责人等信息
                                ...
                                <div class="Normal Editor CheckBox">
                                    <div class="InputField">
                                        ...
                                        <div class="EditorLabelContainer">
                                            <div class="Label">
                                                <label>
                                                    Can access Knowledgebase - Add, Edit, and Delete permissions are configured per resource on the
