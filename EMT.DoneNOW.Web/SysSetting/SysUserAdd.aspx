    ...
    <form id="form1" runat="server" method="post" enctype="multipart/form-data">
        ...
        <script>
            ...
            function SaveInterCost() {
                ...
                requestData("/Tools/ResourceAjax.ashx?act=AddResInternalCost&userId=0&date=" + $("#addInterCostDate").val() + "&rate=" + $("#addInterCostRate").val(), null, function (data) {
                    if (data == false) {
                        LayerMsg("生效开始时间不能重复！");
                        return;
                    } else {
            ...
            function DeleteInterCost(id) {
                requestData("/Tools/ResourceAjax.ashx?act=DeleteResInternalCost&userId=0&id=" + id, null, function (data) {
                    if (data == false) {
            ...
            window.onload=function () {
                requestData("/Tools/ResourceAjax.ashx?act=AddResInternalCost", null, function (data) {
                    if (data != false) {
                        SetInterCost(data);
                    }
                })
