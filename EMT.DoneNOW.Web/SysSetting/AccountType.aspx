<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccountType.aspx.cs" Inherits="EMT.DoneNOW.Web.AccountType" %>
            ...
            <tbody>
                <tr>
                    <td width="30%" class="FieldLabels">
                        ...
                        <div>
                            <asp:TextBox ID="AccoountType_Name" runat="server" style="width:306px"></asp:TextBox>
                        </div>
                    </td>
                </tr>
                <tr>
