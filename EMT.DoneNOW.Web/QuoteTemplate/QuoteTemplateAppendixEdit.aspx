<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuoteTemplateAppendixEdit.aspx.cs" Inherits="EMT.DoneNOW.Web.QuoteTemplateAppendixEdit" %>
...
<body>
    ...
    <div class="Section">
        <div class="Heading">附录</div>
        <div class="DescriptionText">这是附录</div>
        <div class="Content">
