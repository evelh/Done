...
<head runat="server">
    ...
    <title>查看客户-<%=crm_account?.name %></title>
...
<body>
    <form id="form1" runat="server">
            ...
            <i>
                <ul>
                    ...
                    <%if (CheckAuth("CRM_COMPANY_VIEW_COMPANY_VIEW_FINANCIAL"))
                        { %>
                    <li><a href="ViewCompany.aspx?id=<%=account.id %>&type=finance">财务</a></li>
                    <%}%>
        ...
        <div class="header-title" style="width: 480px;">
            <ul>
                ...
                <%if (CheckAuth("CRM_COMPANY_VIEW_COMPANY_REPORT"))
                    { %>
                <li onclick="ShowAccountReport()"><i style="background: url(../Images/ButtonBarIcons.png) no-repeat -96px 0;"></i>
        ...
        <div style="display: none;" id="FinancialsDiv">
            ...
            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; padding-top: 10px">
                ...
                <tbody>
                    <tr>
                        <td>
                            <div class="DivSectionWithHeader">
                                <div class="Heading"><span class="Text">财务报表</span></div>
                                <div class="Content">
                                    <table>
                                        <tbody>
                                            <tr>
                                                <td style="padding-bottom: 10px">
                                                    <a style="font-weight: 700; font-size: 12px" runat="server" id="ToPdfSummary" onserverclick="ToPdfSummary_ServerClick">执行摘要</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding-bottom: 10px">
                                            ...
                                            <tr>
                                                <td style="padding-bottom: 17px">
                                                    <a style="font-weight: 700; font-size: 12px" onclick="ShowIframe('ResWorkHour')">员工已工作时间</a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                    ...
                    <tr>
                        <td>
                            <div class="DivSectionWithHeader">
                                <div class="Heading"><span class="Text">利润率报表</span></div>
                                <div class="Content">
                                    <table>
                                        <tbody>
                                            <tr>
                    ...
                    <tr>
                        <td class="txtBlack8Class" style="padding: 4px 10px 4px 10px;">
                            <img src="../Images/alert.png" />&nbsp;&nbsp;这是父公司。这些报告中的数据包括与父公司合同相关的子公司项目的收入。子公司的收费项目将显示在子公司的财务报告中。
                        </td>
                    </tr>
                </tbody>
            </table>
