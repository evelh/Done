    ...
    <form id="form1" runat="server">
        ...
        <div class="ExpenseDetail">
            <table>
                <tbody>
                    <tr>
                        <td class="LeftTd FieldLabels">创建人
                        </td>
                        <td>
                    ...
                    <tr>
                        <td class="LeftTd FieldLabels">费用日期
                        </td>
                        <td>
                    ...
                    <tr>
                        <td class="LeftTd FieldLabels">费用类别
                        </td>
                        <td>
                    ...
                    <tr>
                        <td class="LeftTd FieldLabels">工作类型
                        </td>
                        <td>
                    ...
                    <tr>
                        <td class="LeftTd FieldLabels">描述
                        </td>
                        <td>
				...
				<td>
                    ...
                    <tr>
                        <td class="LeftTd FieldLabels">收据总额
                        </td>
                        <td>
                    ...
                    <tr>
                        <td class="LeftTd FieldLabels">待报销
                        </td>
                        <td>
                    ...
                    <tr>
                        <td class="LeftTd FieldLabels">付款类型
                        </td>
                        <td>
                    ...
                    <tr>
                        <td class="LeftTd FieldLabels">有收据
                        </td>
                        <td>
                    ...
                    <tr>
                        <td class="LeftTd FieldLabels">计费
                        </td>
                        <td>
                    ...
                    <tr>
                        <td class="LeftTd FieldLabels">已计费
                        </td>
                        <td>
