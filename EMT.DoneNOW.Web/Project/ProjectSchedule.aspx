                ...
                <div class="DropDownButtonDiv">
                    <div class="Group">
                        <div class="Content">
                            ...
                            <div class="Button1" id="PhasesButton" tabindex="0" onclick="ChangeShowPage('phase')">
                                <span class="Text">阶段</span>
                            </div>
                            <div class="Button1" id="PhaseBudgetsButton" tabindex="0" onclick="ChangeShowPage('phaseBudHours')">
                    ...
                    <div class="Group">
                        ...
                        <div class="Content">
                            <div class="Button1" id="OverdueButton" tabindex="0" onclick="ChangeShowPage('ExpiredTask')">
                                <span class="Text">过期</span>
                            </div>
                            <div class="Button1" id="CompleteButton" tabindex="0" onclick="ChangeShowPage('TaskComplete')">
                                <span class="Text">完成</span>
                            </div>
                            <div class="Button1" id="IncompleteButton" tabindex="0" onclick="ChangeShowPage('TaskNoComplete')">
                            ...
                            <div class="Button1" id="IssuesButton" tabindex="0" onclick="ChangeShowPage('Issues')">
                                <span class="Text">问题</span>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    // 根据选择的条件过滤页面上的数据
    function ChangeShowPage(showType) {
        location.href = "ProjectSchedule?project_id=<%=thisProject.id %>&pageShowType=" + showType;
    }
