   ...
   <form id="AddCompany" name="AddCompany" runat="server">
    ...
    <script type="text/javascript">
        ...
        function OpenWindowCompany() {
            window.open("../Common/SelectCallBack.aspx?type=查找客户&field=accCallBack&callBack=GetCompany", "<%=EMT.DoneNOW.DTO.OpenWindow.CompanySelect %>", 'left=200,top=200,width=600,height=800', false);
        }
        function OpenWindowLocation(fld) {
            window.open("../Common/SelectCallBack.aspx?type=查找客户&field=" + fld, "<%=EMT.DoneNOW.DTO.OpenWindow.ContactLocationSelect %>", 'left=200,top=200,width=600,height=800', false);
        }
        function GetCompany() {
