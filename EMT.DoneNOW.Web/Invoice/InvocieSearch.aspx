<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvocieSearch.aspx.cs" Inherits="EMT.DoneNOW.Web.Invoice.InvocieSearch" %>
...
<frameset id="SearchFrameSet" name="SearchFrameSet" rows="<%=conditionHeight %>,*" cols="100%" framespacing="0" border="0">
    ...
    <frame src="InvoiceSearchResult.aspx?cat=<%=this.catId %>&type=<%=this.queryTypeId %>&group=<%=paraGroupId %>&show=1&isCheck=<%=isCheck %>" id="SearchBody"></frame>
</frameset>
    <%} else { %>
