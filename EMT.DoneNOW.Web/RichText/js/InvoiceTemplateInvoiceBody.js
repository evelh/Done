...
//点击第三块
$(".Edit222").on("click",function(){
    var $_this=$(this);
    loading();
    var innerContent = $(this).parent().next().next().html();
    var mask = $('<div id="BackgroundOverLay">'+'</div>');
    var Model1='<div class="Section Collapsed" style="margin-left: 16px;z-index: 1000;">'+
        '<div class="Heading">'+
        '<div class="Toggle Collapse Toggle1">'+
        '<div class="Vertical"></div>'+
        '<div class="Horizontal"></div>'+
        '</div>'+
        '<span class="Text">ADDITIONAL SETTINGS</span>'+
        '</div>'+
        '<div class="Content">'+
        '<div class="Normal Column">'+
        '<div class="EditorLabelContainer">'+
        '<div class="Label">'+
        '<label>Display Labour associated with:</label>'+
        '</div>'+
        '</div>'+
        '<div class="Normal Editor CheckBox">'+
        '<div class="InputField">'+
        ...
        '<div class="EditorLabelContainer">'+
        '<div class="Label">'+
        '<label>Recurring Service Contracts</label>'+
        '</div>'+
        '</div>'+
        '</div>'+
        '</div>'+
        ...
        '<div class="EditorLabelContainer">'+
        '<div class="Label">'+
        '<label>Fixed Price Contracts</label>'+
        '</div>'+
        '</div>'+
        '</div>'+
        '</div>'+
        ...
        '<div class="EditorLabelContainer">'+
        '<div class="Label">'+
        '<label>Rate/Cost column - unit of measure(ex: /hour)</label>'+
        '</div>'+
        '</div>'+
        '<div class="Normal Editor TextBox">'+
        '<div class="InputField">'+
        ...
        '</div>'+
        '</div>';
    var Model2 = '<div class="Section Collapsed" style="margin-left:16px;">'+
        '<div class="Heading">'+
