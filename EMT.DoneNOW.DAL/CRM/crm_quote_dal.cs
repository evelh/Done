...
left join (select cl.*,(select name from d_district where id=cl.city_id) city,(select name from d_district where id=cl.province_id) province,(select country_name_display from d_country where id=cl.country_id) country from sys_organization_location cl)l on u.location_id = l.id where o.delete_time=0    and o.id=" + oid + " and 1=1  order by o.name) as oo,");
            ...
            sql.Append(@"(
            select  '上海声联网络科技有限公司' as '[公司名称：名称]', '上海市天目西路290号康吉大厦市政楼1405-1409室' as '[公司名称：地址]', null as '[公司名称：补充地址]',null as '[公司名称：其他地址]', '上海' as '[公司名称：城市]', '上海' as '[公司名称：省]', '200070' as '[公司名称: 邮编]', '中国' as '[公司名称：国家]',null as '[公司名称：其它地址信息]', '(86) 021-61506999' as '[公司名称：电话]', '(86)021-61303566' as '[公司名称：传真]', 'http://www.voiceonline.com.cn' as '[公司名称：网址]',null as '[公司名称：税编号、ACN、ABN、VAT等。]'  from(select 1 num) a where 1 = 1 and 1 = 1  order by  num) as kk");
