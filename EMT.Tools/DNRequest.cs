...
namespace EMT.Tools
{
    ...
    public class DNRequest
    {
        ...
        public static string GetQueryString(string strName, bool sqlSafeCheck)
        {
            ...
            if (sqlSafeCheck && !Common.IsSafeSqlString(HttpContext.Current.Request.QueryString[strName]))
        ...
        public static string GetFormString(string strName, bool sqlSafeCheck)
        {
            ...
            if (sqlSafeCheck && !Common.IsSafeSqlString(HttpContext.Current.Request.Form[strName]))
                return "unsafe string";
        ...
        {
            return Common.StrToInt(HttpContext.Current.Request.QueryString[strName], 0);
        }
        ...
        {
            return Common.StrToInt(HttpContext.Current.Request.QueryString[strName], defValue);
        }
        ...
        {
            return Common.StrToInt(HttpContext.Current.Request.Form[strName], defValue);
        }
        ...
        {
            return Common.StrToDecimal(HttpContext.Current.Request.QueryString[strName], defValue);
        }
        ...
        {
            return Common.StrToDecimal(HttpContext.Current.Request.Form[strName], defValue);
        }
        ...
        {
            return Common.StrToFloat(HttpContext.Current.Request.QueryString[strName], defValue);
        }
        ...
        {
            return Common.StrToFloat(HttpContext.Current.Request.Form[strName], defValue);
        }
